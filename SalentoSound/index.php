...
<html>
	<head>
  	...
  	<body>
          ...
          <div class="corpo">
          	<h1 style="padding-left: 20px;">Eventi Last-Minute</h1>
            ...
            <div class="eventi">
            	<?php
                    ...
                    WHERE E.DataOra BETWEEN NOW() AND DATE_ADD(NOW(), INTERVAL 12 HOUR)
                    ...
                    if ($result->num_rows === 0) {
                        echo("<div class='eventCard'>
                                <p>Al momento non ci sono eventi in programma per le prossime 12 ore. Torna a trovarci più tardi!</p>
                              </div>");
                    } else {
